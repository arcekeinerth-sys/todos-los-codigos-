...
class Program { static void Main() { // Pide al usuario que ingrese su nombre Console.Write("Por favor, escribe tu nombre: "); string nombre = Console.ReadLine(); // Lee el nombre desde el teclado
...
class Program { static void Main(string[] args) { // Pedir 4 números al usuario Console.Write("Ingrese el primer número: "); int a = int.Parse(Console.ReadLine());
...
public class Rectangulo { // Atributos private double baseRect; private double altura;
...
class Program { static void Main(string[] args) { // Instanciar un rectángulo (ejemplo: 10 x 5) Rectangulo r = new Rectangulo(10, 5);
...
class Program { static void Main(string[] args) { Person myObj = new Person(); myObj.Name = "Liam"; Console.WriteLine(myObj.Name); } }# todos-los-codigos-
